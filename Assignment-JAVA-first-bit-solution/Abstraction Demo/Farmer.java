...
class DairyFarmer extends Farmer
{
	...
	public String toString()
	{
		return super.toString()+"\nNo of cattles : "+this.noofcattles+"\nMilk Produced per day : "+this.milkproducedperday+"\nDairy Licence is : "+this.dairylicenceno;
	}
...
class PoultryFarmer extends Farmer
{
	...
	public String toString()
	{
		return super.toString()+"\nNo of chickens : "+this.noofchickens+"\nNo of Hens : "+this.noofhens+"\nNo of shades : "+this.noofshades+"\nEgg Produced per day : "+this.eggproducedperday+"\nShades capacity : "+this.shadecapacity+"\nPoultry Name : "+this.poultryname;
	}
...
class OrganicFarmer extends Farmer
{
	...
	public String toString()
	{
		return super.toString()+"\nOrganicer Id : "+this.organicertid+"\nCropType : "+this.croptype+"\nNo of Fertilized : "+this.noofFertilized;
	}
