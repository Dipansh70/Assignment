...
abstract class GovernmentDocument
{
	int documentId;
    String holderName;
    String issueDate;
...
class Passport extends GovernmentDocument
{
	...
	public String toString()
	{
		return super.toString()+"\nCountry of issue : "+this.countryOfIssue+"\nPassport type : "+this.passportType+"\nNo of visa pages : "+this.novisaPages+"\nNationality : "+this.nationality+"\nHas visa stamp : "+this.hasVisaStamp;
	}
...
class DrivingLicense extends GovernmentDocument
{
	...
	void purpose()
	{
		System.out.println("Used for driving\n");
	}
	
	
	public String toString()
	{
		return super.toString()+"\nVehicle type : "+this.vehicleType+"\nLicense Number : "+this.licenseNumber+"\nBlood Group : "+this.bloodGroup+"\nNo of validity Years : "+this.noofvalidityYears+"\nIs test passed : "+this.istestPassed;
	}
...
class VoterID extends GovernmentDocument
{
	...
	void purpose()
	{
		System.out.println("Used for voting\n");
	}
	
	
	public String toString()
	{
		return super.toString()+"\nConstituency : "+this.constituency+"\nVoter Number : "+this.voterNumber+"\nPolling Booth : "+this.pollingBooth+"\nElection year : "+this.electionYear+"\nIs Eligible : "+this.isEligible;
	}
...
class TestGovernmentDocument
{
	...
	{
		GovernmentDocument g1;//generic reference
//		g1=new GovernmentDocument();
//		g1.display();
//		g1.purpose();
		
		g1=new Passport(201, "Priya Deshmukh", "2020-07-01", "2030-07-01","Ministry of External Affairs", "Mumbai", true,"India", "Diplomatic", 60, "Indian", true);//upcasting
		//g1.display();
		System.out.println(g1);
		g1.purpose();
		
		g1=new DrivingLicense();//upcasting
		//g1.display();
		System.out.println(g1);
		g1.purpose();
		
		g1=new VoterID(401, "Neha Patil", "2022-09-10", "2032-09-10", "Election Commission of India", "Nagpur", true,"Nagpur Central", "MH2023456", "Booth No. 21, City College", 2024, true);//upcasting
		//g1.display();
		System.out.println(g1);
		g1.purpose();
	}
