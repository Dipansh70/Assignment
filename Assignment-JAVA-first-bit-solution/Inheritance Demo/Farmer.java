...
class TestFarmer
{
	public static void main(String[]args)
	{
		...
		DairyFarmer d1=new DairyFarmer(301, "Rohit Mane", "Sangli", 350000, 7000, 80.0, 12, 25, 450, 202);
		d1.display();
		
		PoultryFarmer p1=new PoultryFarmer();
		p1.display();
		
		OrganicFarmer o1 =new OrganicFarmer(501, "Anita Jadhav", "Nashik", 200000, 4000, 35.7, 6, 909, "Sugarcane", 50);
		o1.display();
	}
}
