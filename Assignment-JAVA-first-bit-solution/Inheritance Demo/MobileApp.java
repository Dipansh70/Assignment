...
class TestMobileApp
{
	public static void main(String[]args)
	{
		...
		MessagingApp mes = new MessagingApp("Telegram", "Pavel Durov", 180.0, 8000000, 4.5, 2013, "iOS",true, 1200000, true, 1000, true);
		mes.display();
		
		ShoppingApp s1=new ShoppingApp();
		s1.display();
		
		FitnessApp f1=new FitnessApp("FitTrack", "FitCorp", 95.2, 700000, 4.4, 2018, "Android",30, 250.0, 4999.0, true, "Muscle Gain");
		f1.display();
	}
