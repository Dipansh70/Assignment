...
class TestSocialMediaAccount
{
	public static void main(String[]args)
	{
		...
		LinkedInAccount l1=new LinkedInAccount("pro_sayali", "sayali@linkedin.com", "India", "2021-02-15", true, true, 50, 600, 90, 1200,1000, 500, 50);
		l1.display();
		
		YoutubeAccount y1=new YoutubeAccount("Sonal", "Sonal@yt.com", "UK", "2022-01-01",true, false, 300, 9000, 450, 150000,15000, 900.5, true, 25000.75);
		y1.display();
	}
}
